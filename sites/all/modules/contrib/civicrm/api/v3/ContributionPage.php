 ...
 */
function _civicrm_api3_contribution_page_delete_spec( &$params ) {
...
function civicrm_api3_contribution_page_get($params) {
    if(CRM_Utils_Array::value('id', $params) ){
        ...
        $params['contribution_page_id'] = CRM_Utils_Array::value('contribution_page_id', $params,$params['id']);
        unset ($params['id']);
    }
 ...
 */
    ...
    $contribution_page = array('Hello' => 'World');
    return $contribution_page;

    //return civicrm_api3_create_success ( $contribution_page, $params, 'contribution','get',$dao);
    //return civicrm_api3_create_success ( $contribution_page, $params, 'contribution_page','get',null);
}
/*
 ...
 * @param array $params array or parameters determined by getfields
 */
function _civicrm_api3_contribution_page_get_spec(&$params){
    /*
 ...
 * 
 */
function civicrm_api3_contribution_page_transact($params) {
    /*
